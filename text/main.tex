...
% \documentclass[enabledeprecatedfontcommands,bibliography=totoc,listof=totoc,index=totoc,twoside=true,BCOR=12mm,DIV=12,hidelinks]{scrbook}
...
\lmudeadline{11. Mai 2021}                      % deadline (day of submission)
%
% =================================================================================================
...
%
    ...
    \input{text/navigation_problem/00_navigation_problem}
    \input{text/luna_lander/luna_lander}
